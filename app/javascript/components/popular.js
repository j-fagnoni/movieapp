...
const fetchPopular = () => {
  ...
  if (popularMovies) {
    ...
    fetch(`https://api.themoviedb.org/3/movie/popular?api_key=e4f80194d29b9ac6bb8e120c3874b12e&language=en-US&page=1`)
    .then(response => response.json())
    .then((data) => {
      data.results.forEach(movie => displayPopular(movie));
    })
  }
}
